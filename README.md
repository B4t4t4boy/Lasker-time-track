...
Built with **Flutter**, this app compiles down to native standalone executables for both **Linux** and **Windows**, requiring no underlying development dependencies for the end-user.
